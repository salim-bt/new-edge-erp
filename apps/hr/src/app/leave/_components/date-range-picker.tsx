...
import { DateInput } from '@/app/leave/_components/date-input'
...
const PRESETS: Preset[] = [
  ...
  { name: 'twoDays', label: '2 Days' },
  { name: 'threeDays', label: '3 Days' },
  { name: 'fourDays', label: '4 Days' },
  { name: 'fiveDays', label: '5 Days' },
  { name: 'oneWeek', label: '1 Week' },
  { name: 'twoWeeks', label: '2 Weeks' },
]
...
export const DateRangePicker: FC<DateRangePickerProps> & {
  ...
  const getPresetRange = (presetName: string): DateRange => {
    ...
    switch (preset.name) {
        ...
        case 'threeMonths':
            ...
            break
        case 'sixMonths':
            from.setMonth(from.getMonth() + 6, 0)
            from.setDate(from.getDate())
  ...
  return (
    <Popover modal={true} open={isOpen} onOpenChange={(open: boolean) => {
      ...
      <PopoverContent align={align} className="w-auto h-auto" >
...
DateRangePicker.filePath =
  '@/app/leave/_components/date-range-picker.tsx'
